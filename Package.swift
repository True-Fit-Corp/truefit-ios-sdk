...
//
// The release job fills in 2.0.6 and 8fcb1447301c1717cfcaccaaf7aa32706bbd61985a795e352e25dc22354a7e58 (the checksum printed
// by scripts/build-xcframework.sh), writes the result as `Package.swift` in the
// public repo, commits it, and tags the commit `2.0.6`. Consumers then:
//
//   .package(url: "https://github.com/True-Fit-Corp/truefit-ios-sdk.git", from: "2.0.6")
//
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TrueFitRecommendation",
            url: "https://github.com/True-Fit-Corp/truefit-ios-sdk/releases/download/2.0.6/TrueFitRecommendation.xcframework.zip",
            checksum: "8fcb1447301c1717cfcaccaaf7aa32706bbd61985a795e352e25dc22354a7e58"
        )
    ]
)
