...
//
// The release job fills in 2.0.1 and 0f6cac83abea3b19025c0c8750f8a1bcb053ee11578722fb4af69db18372d246 (the checksum printed
// by scripts/build-xcframework.sh), writes the result as `Package.swift` in the
// public repo, commits it, and tags the commit `2.0.1`. Consumers then:
//
//   .package(url: "https://github.com/True-Fit-Corp/truefit-ios-sdk.git", from: "2.0.1")
//
...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "TrueFitRecommendation",
            url: "https://github.com/True-Fit-Corp/truefit-ios-sdk/releases/download/2.0.1/TrueFitRecommendation.xcframework.zip",
            checksum: "0f6cac83abea3b19025c0c8750f8a1bcb053ee11578722fb4af69db18372d246"
        )
    ]
)
